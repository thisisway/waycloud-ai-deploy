...
3. **Configurar:**
   ...
   - O restante já vem com padrões (Pix `efipix`, domínio provisório `sites.wayleads.com.br`, link válido por 48 h, Termos, Privacidade, `contato@waycloud.com.br`, endereço padrão).
...
- Se o Plesk aceita criar a assinatura em `<slug>.sites.wayleads.com.br` sem que o DNS já exista.
